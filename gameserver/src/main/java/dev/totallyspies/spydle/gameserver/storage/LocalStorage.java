...
/**
 * A local in-memory storage implementation for our gameserver to store data in. This storage is
 * exclusive to a singular gameserver instance. This should only be used for local testing.
 */
@Service
...
public class LocalStorage implements GameServerStorage {
  ...
  public LocalStorage() {
    LoggerFactory.getLogger(LocalStorage.class)
        .info("Found storage.type=local, loading LocalStorage");
  }
