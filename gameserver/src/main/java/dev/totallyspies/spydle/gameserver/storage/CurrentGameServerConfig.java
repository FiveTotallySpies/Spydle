...
/**
 * Configuration to decide which bean should declare how we get information about our current
 * gameserver. If agones is enabled, we use the Agones Hook to retrieve this information from Agones
 * Controller Service. If agones is disabled, we use fake local details.
 */
@Configuration
