...
public class GameLogicTests {
  ...
  public void testGuess() {
    ...
    assertTrue(gameLogic.isPlayerTurn(uuid2));
    System.out.println(
        "testGuess() substring:" + gameLogic.getCurrentSubString()); // current substring: a
  ...
  public void testScore() {
    ...
    assertTrue(gameLogic.isPlayerTurn(uuid3));
    System.out.println(
        "testScore() substring:" + gameLogic.getCurrentSubString()); // current substring: b
    ...
    assertTrue(gameLogic.isPlayerTurn(uuid2));
    System.out.println(
        "testScore() substring:" + gameLogic.getCurrentSubString()); // current substring: c
