...
import dev.totallyspies.spydle.gameserver.game.GameLogicEvents;
...
class GameLogicEventsTests {
    ...
    void setUp() {
        ...
        gameLogicEvents = spy(new GameLogicEvents(
                gameLogic,
                gameSocketHandler,
                gameServer,
                gameServerConfig,
        ...
        gameStartEvent = SbStartGame
                .newBuilder()
                .setTotalGameTimeSeconds(100)
                .setTurnTimeSeconds(20)
                .build();
    }
    ...
    void testGuessUpdate() {
        ...
        var guessUpdateEvent = SbGuessUpdate
                .newBuilder()
                .setGuessedWord("word")
                .build();
    ...
    void testGuess() {
        ...
        System.out.println("testGuess(): current player: " + gameLogic.getCurrentPlayer().getName()); //player2

        var guessEvent = SbGuess
                .newBuilder()
                .setGuessedWord("word")
                .build();
