...
public class MatchmakingServiceTest {
  ...
  @Mock private AgonesAllocatorService allocator;
  ...
  public void testCreateGame_ClientAlreadyConnected() {
    ...
    ClientSession existingSession =
        fakeClientSession.toBuilder().state(ClientSession.State.CONNECTED).build();
  ...
  public void testListGames() {
    ...
    when(gameServerRepository.getGameServers())
        .thenReturn(List.of(gameServer1, gameServer2, gameServer3));
