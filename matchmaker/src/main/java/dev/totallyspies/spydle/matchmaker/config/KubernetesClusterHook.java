...
public class KubernetesClusterHook {
  ...
  public AllocationServiceGrpc.AllocationServiceStub allocationServiceStub(
    ...
    logger.info(
        "For agones allocator service {} in namespace {}, found target {}:{} for game fleet {} in namespace {}",
        serviceName,
        namespace,
        allocatorClusterIP,
        port,
    ...
    ManagedChannel managedChannel =
        ManagedChannelBuilder.forAddress(allocatorClusterIP, port)
            .usePlaintext()
            .enableRetry()
    ...
    AllocationServiceGrpc.AllocationServiceStub stub =
        AllocationServiceGrpc.newStub(managedChannel);
