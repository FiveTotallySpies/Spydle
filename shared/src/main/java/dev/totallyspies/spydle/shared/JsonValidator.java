    ...
    public static void validateJsonElement(JsonElement object, Class<?> clazz) {
        ...
        for (Field field : clazz.getDeclaredFields()) {
            ...
            if ((fieldType == String.class && !element.isJsonPrimitive()) ||
                    (fieldType == int.class && (!element.isJsonPrimitive() || !element.getAsJsonPrimitive().isNumber())) ||
                    (fieldType == boolean.class && (!element.isJsonPrimitive() || !element.getAsJsonPrimitive().isBoolean())) ||
                    (fieldType.isEnum() && (!element.isJsonPrimitive() || !isValidEnum(fieldType, element.getAsString())))) {
